...
❯ I want you to, I need you to test all. I want you to add, to change, to change schedule   
task v1md accordingly so that cron task will also trigger correct change. I want you to     
test all MCP-related via real mcp protocol via real conversation, via real conversation so  
that just not calling tools, that you just track how real person will interact with it. You 
 must be God testers here to catch any misleading patterns, any shit, and solve it as a     
cat, you know? Don't stop until you finish. Just test it and use it, you know? So, should   
very ahead of a user, write real stuff as a user, then, like, each answer from MCP should   
be scored whether it's match what it was expected, whether it was match. Build test         
framework perfectly for MCP testing. Learn how guys testing MCP, but I mean, how it, how    
state-of-art testing MCP look like, but definitely, it's not about calling tools, it's      
about testing real conversations. I want you to test all conversation in the test           
directory.      


 fix everyrhing always and don't stop until all fixed, act as architecture god, you can    
  do everything so do it as god                                                             
  ...
  propelry youtself before what's this test flow is gonna look like for a user              
  interacting with god level mcp                                                            
