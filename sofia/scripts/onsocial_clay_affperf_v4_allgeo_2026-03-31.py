#!/usr/bin/env python3
"""
OnSocial Clay Pipeline (AFFILIATE_PERFORMANCE v4, ALL GEO, 2026-03-31)
...
Filters from: sofia/projects/OnSocial/docs/apollo-filters-v4.md (Segment 2)
  - 41 description_keywords (v3 base + v4 new: loyalty, rewards, cashback, attribution, etc.)
  - 32 description_keywords_exclude
  - Employees: 20-5,000
  - Industries: 6 (Computer Software, Internet, Marketing & Advertising, IT, E-commerce, Online Media)
  - ALL GEO (no country_names filter)
  - Target: 800-1,500 companies (v4 estimate)

People filters (v4):
  - Management Level: c_suite, vp, director, owner, senior, head, partner, founder
  - Titles: 31 titles (v4: added Head of Growth, VP Growth, Director of Growth, etc.)
