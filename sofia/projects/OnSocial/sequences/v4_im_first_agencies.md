...
## Email 1A - Brand Fear (Day 0)

**Subject:** creator analytics - {{company_name}}
...
## Email 2B - Demo Offer (Day 4)

**Subject:** Re: creator analytics - {{company_name}}

Hi {{first_name}}, easier to show than explain.

I can build a sample report for {{company_name}} - your logo, your colors, real creator data. Takes me 10 minutes.
...
## Email 3 - Client Retention Angle (Day 8)
...
## Email 4 - Build vs Buy for Agencies (Day 14)
...
1. Create campaign: `IM-FIRST AGENCIES v4`
