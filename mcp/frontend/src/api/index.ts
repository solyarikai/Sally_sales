...
export const contactsApi = {
  ...
  async deleteProject(_id: number) { return {} },
  async getProjectAISDR(_id: number) { return {} },
  async generateTAM(_id: number) { return {} },
  async generateGTM(_id: number) { return {} },
  async generatePitches(_id: number) { return {} },
  async generateAllAISDR(_id: number) { return {} },
  async getImportTemplate() { return new Blob() },
  async importCsvBulk(_file: File, _opts: any): Promise<ImportResult> { return { success: true, imported: 0, errors: [] } },
  async create(_data: any) { return {} },
  async update(_id: number, _data: any) { return {} },
  async delete(_id: number) { return {} },
  async bulkCreate(_data: any) { return {} },
  async createProject(_data: any) { return {} },
  async updateProject(_id: number, _data: any) { return {} },
  async verifyCampaigns(_names: string[]) { return {} },
}
